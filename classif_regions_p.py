...
class Params(object):
    ...
    def __init__(self):
        ...
        self.bn_model = 'data/finetune_classif/fou_best_alexnet_classif_finetuned.pth.tar'
        ...
        self.train_sub_scales = [transforms.Compose([]), transforms.Compose([affine_scale_noisy_cv(2.)])]
